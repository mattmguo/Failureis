function Sticky() {
  return (
    <div className="absolute left-[530px] size-[382px] top-[208px]" data-name="Sticky 6">
      <div className="absolute bg-[#c5dded] left-0 shadow-[0px_2.825px_3.531px_2.825px_rgba(168,168,168,0.25)] size-[382px] top-0" data-name="newww" />
      <p className="absolute font-['Lora:Regular',sans-serif] font-normal h-[217px] leading-[46.008px] left-[43px] text-[#163612] text-[30.672px] top-[43px] w-[294px]">learning to believe in myself time and time again</p>
    </div>
  );
}
...
export default function MacBookPro() {
  return (
    <div className="bg-[#fcf8f3] relative size-full" data-name="MacBook Pro - 22">
      ...
      <p className="-translate-x-full absolute font-['Oatmeal_Pro_TRIAL:Medium','Noto_Sans:Medium',sans-serif] leading-[36px] left-[1396px] text-[#134025] text-[78px] text-right top-[808px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 500" }}>
        →Submit
      </p>
